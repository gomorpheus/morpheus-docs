...
SYNTHETIC FULL (Currently only available for KVM VM Snapshot-type backups, such as those used with |hvm| Instances. More Layout types are expected to support synthetic full backups in the future)
