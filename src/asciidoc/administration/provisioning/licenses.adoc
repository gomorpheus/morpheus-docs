...
Description:: License description displayed in the Licenses list in {morpheus}. Helpful for identifying License after creation
Virtual Images:: Search for existing Virtual Images by name and select to attach the image to the license.
