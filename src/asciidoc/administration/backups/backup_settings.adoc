...
Backup settings can be configured under `Administration -> Backups`
...
Copy Snapshots to Store:: Copy VMware snapshots to selected Backup Storage Provider.
...
include::veeam_config.adoc[]
include::commvault_config.adoc[]
