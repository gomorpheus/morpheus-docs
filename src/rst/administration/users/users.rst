...
-  Password
-  Storage size set in megabytes. (0.0 is unlimited, this is the amount
   of storage a role can provision.)
-  Memory size set in megabytes. (0.0 is unlimited, this is the amount
   of memory a role can provision.)
