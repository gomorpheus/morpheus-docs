...
Prior to provisioning an custom image, the image must be configured in the :menuselection:`Library --> Virtual Images` section by selecting Edit on the Actions dropdown of the Virtual Image.
