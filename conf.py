...
latex_documents = [
    (master_doc, 'morpheus_6.0.1-1.tex', u'Morpheus Documentation',
     u'Morpheus', 'manual'),
]

rst_prolog = """

.. |releasedate| replace:: Mar 14 2023
.. |morphbranch| replace:: v6.0
.. |morphver| replace:: v6.0.1
.. |minUpgradeVer| replace:: v5.2.0
.. |previousMorphVer| replace:: v6.0.0
.. |pluginVer| replace:: 0.13.7
