...
latex_documents = [
    (master_doc, 'morpheus_6.2.11-1.tex', u'Morpheus Documentation',
     u'Morpheus', 'manual'),
]
...
.. |morphver| replace:: v6.2.11
.. |minUpgradeVer| replace:: v6.0.0
.. |minRollingUpgradeVer| replace:: v7.0.3
.. |nonRollingUpgradeVer| replace:: v7.0.2
.. |previousMorphVer| replace:: v6.2.10
.. |pluginVer| replace:: 0.15.14
...
.. |tcver| replace:: v9.0.88
.. |nginxver| replace:: v1.25.1
.. |nodePackageVer| replace:: 3.2.24
...
.. |InfStoBuc| replace:: Infrastructure > Storage > Buckets
