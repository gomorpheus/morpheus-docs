...
.. |previousMorphVer| replace:: v5.4.11
...
extensions = ['recommonmark','sphinxcontrib.contentui','sphinx_tabs.tabs','sphinxcontrib.images','sphinx_search.extension','notfound.extension','sphinx.ext.autosectionlabel','sphinx_rtd_dark_mode','sphinx_copybutton'] #sphinx_tabs ''
