...
latex_documents = [
    (master_doc, 'morpheus_6.0.2-1.tex', u'Morpheus Documentation',
     u'Morpheus', 'manual'),
]

rst_prolog = """

.. |releasedate| replace:: May 9 2023
.. |releasetype| replace:: LTS
.. |morphbranch| replace:: v6.0
.. |morphver| replace:: v6.0.3
...
extensions = ['recommonmark','sphinx_tabs.tabs','sphinxcontrib.images','sphinx_search.extension','notfound.extension','sphinx.ext.autosectionlabel','sphinx_rtd_dark_mode'] #sphinx_tabs
