...
.. IMPORTANT:: Pricing must be enabled in :menuselection:`Administration --> Settings --> Provisioning` and Service Plans configured with price sets in |AdmPla| for pricing to show in the Usage section.
