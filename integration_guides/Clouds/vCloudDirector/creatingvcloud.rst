...
Once you click ok the import process will begin. When the import has completed the template will appear in |morpheus| within :menuselection:`Library --> Virtual Images`
