...
The selected Docker layout may expose a configurable data volume. A dedicated second disk is not required for every VMware Docker Host; configure the volumes required by the selected layout and your storage design.
