...
Navigate to |InfClo| and click :guilabel:`+ ADD`. As long as the Nutanix Prism Central plugin has been added to the appliance and this Cloud type isn't disabled in global settings (|AdmSet|), NUTANIX PRISM CENTRAL should be selectable as a Cloud type to add. Select it and click :guilabel:`NEXT`.
