---
title: "Documentation on how to grow a GFS2 datastore"
slug: docs-morph-8707-grow-gfs2-datastore
type: feature
status: completed
horizon: now
size: medium
tags: [documentation, hvm, gfs2, storage]
tracker_id: MORPH-8707
jira_status: New
parent: docs-morph-3266-enhancements
relates-to:
  - docs-morph-9611-grow-gfs2-datastore
created: 2026-08-03
completed_at: 2026-08-03T15:17:20Z
---

# Documentation on how to grow a GFS2 datastore

## Context

Jira: https://hpe.atlassian.net/browse/MORPH-8707

Exact Jira description (delivery source requirement):

> We need documentation on how to grow a GFS2 datastore. I was provided this PDF. 

## Goal

Produce accurate, version-scoped documentation that resolves MORPH-8707 without converting reported observations into unsupported product guarantees. Completion includes SME verification for all behavior not already established by maintained documentation.

## Kickoff

Deliver `.hero/planning/features/docs-morph-8707-grow-gfs2-datastore/spec.md`. Start by reading the exact Jira description above, then inspect and update only the validated subset of:
...
Reconcile the request with current guidance that capacity is added through additional datastores; only document in-place growth if an approved, version-scoped runbook establishes support.
...
- WHEN a reader follows the affected workflow THE DOCUMENTATION SHALL state the verified prerequisites, decision points, and expected result for MORPH-8707
...
- BLOCKED: the referenced PDF is not present in the supplied Jira export. Obtain it, resolve duplicate ownership with MORPH-9611, and secure storage-engineering approval before documenting commands.
