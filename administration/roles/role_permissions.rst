...
>>>>>>> 4aa5265e (scrub references to Venafi integration)
...
- .. toggle-header:: :header: **Monitoring Permission Options**
    ...
    .. list-table::
      ...
      * - Monitoring: Logs (Formerly Logs)
        ...
        - |MonLog| is where Instance and Server logs may be viewed (also must be enabled in order to view Appliance logs from |AdmHeaMorLog| when health permission is also enabled).
