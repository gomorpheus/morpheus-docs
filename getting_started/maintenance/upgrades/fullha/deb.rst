...
#. Then upgrade the deb package on App Node 3, and run a Reconfigure on App Node 3
...
#. The upgrade is complete and the |morpheus|-ui services should be running on allocation 3 nodes.
