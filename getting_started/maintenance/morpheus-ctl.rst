...
.. code-block:: bash
     ...
     General Commands:
       ...
       reconfigure
         Reconfigure the application. Reconfigure is not a general credential-rotation operation; for example, it does not change the password of an existing appliance-managed RabbitMQ user. See :doc:`/getting_started/external_services/rabbitmq` before changing RabbitMQ credentials.
       show-config
