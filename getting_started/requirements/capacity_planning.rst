...
In the case of both the AIO and 3-Node HA architectures, |morpheus| nodes can be **scaled up** to a maximum of 32GB, which can support more WLEs per node.  Adding more CPU or memory is possible, without adding additional nodes.
