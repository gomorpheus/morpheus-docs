...
.. IMPORTANT:: Nginx server includes configurations (``nginx['ssl_server_include']`` and ``nginx['server_include']``) are advanced configurations. |morpheus| support will not troubleshoot configuration issues related to these advanced options.
