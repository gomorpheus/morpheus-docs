...
- OpenStack: Fixed an causing network interfaces added to virtual machines on reconfigure to never appear
- NSX-V: General improvements and fixes to firewall groups and rules
- Reports: Deleted or renamed Clouds are now indicated as such in the Cloud Cost Report rather than appearing to be a duplicate line item
