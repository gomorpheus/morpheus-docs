.. raw:: html
   ...
   <thead>
     <tr>
       ...
       <th class="darkGrey" colspan="50">To Version</th>
     </tr>
   </thead>
     <tbody>
     <tr>
       ...
       <td class="red-left" colspan="41" text-align="left">5.4.0+</td>
     </tr>
     <tr>
       <td class="darkGrey">5.2.0-5.3.4→</td>
       <td class="white"></td>
       <td class="green-left">5.4.4-5.5.3</td>
       <td class="red-left" colspan="41">6.0.0+</td>
     ...
     <tr>
       <td class="green" colspan="41">Rolling Upgrade Supported</td>
     </tr>
     <tr>
       <td class="purple" colspan="41">Rolling upgrades for HA environments using embedded RabbitMQ and/or embedded Elasticsearch services are not supported</td>
     </tr>
     <tr>
       <td class="blue" colspan="41">Non-Rolling Upgrade Supported</td>
     </tr>
     <tr>
       <td class="orange" colspan="41">Upgrade Not Recommended*</td>
     </tr>
     <tr>
       <td class="red" colspan="41">Upgrade Not Supported</td>
     </tr>
     <tr>
       <td class="lightGrey" colspan="41">Downgrade Not Supported</td>
     </tr>
   </tbody>
  </table>
 </div>
