.. raw:: html
   ...
   <thead>
     <tr>
       ...
       <th class="darkGrey" colspan="51">To Version</th>
     </tr>
   </thead>
     <tbody>
     <tr>
       ...
       <td class="red-left" colspan="42" text-align="left">5.4.0+</td>
     </tr>
     <tr>
       <td class="darkGrey">5.2.0-5.3.4→</td>
       <td class="white"></td>
       <td class="green-left">5.4.4-5.5.3</td>
       <td class="red-left" colspan="42">6.0.0+</td>
     ...
     <tr>
       <td class="purple" colspan="42">Rolling upgrades for HA environments using embedded RabbitMQ and/or embedded Elasticsearch services are not supported</td>
     </tr>
     <tr>
