...
- Agent installation is required for Master and Worker Nodes. Refer to `Morpheus Agent <https://docs.morpheusdata.com/en/4.1.1/getting_started/agent/morpheus_agent.html>`_ section for additional information.
